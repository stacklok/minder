...
require (
	...
	github.com/openfga/language/pkg/go v0.0.0-20240312214103-2c2688b46b9c // indirect
	...
	github.com/testcontainers/testcontainers-go/modules/mysql v0.29.1 // indirect
